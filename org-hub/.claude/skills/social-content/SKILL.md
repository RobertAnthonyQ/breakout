...
**For Breakout specifically** (if `.agents/product-marketing-context.md` mentions Breakout):
- Primary platform: **Instagram** — feed posts (bold impact or editorial minimalista), Stories, Reels
- Secondary platform: **TikTok** — behind the scenes, clips de eventos, quotes de speakers
- Do NOT suggest LinkedIn, Facebook, or Twitter/X as primary channels
- Also read `.agents/breakout-brand.md` for visual style when describing post designs or mockups
- Tone: directo, retador, joven — nunca corporativo ni motivacional genérico
- Format for event posts: `📅 día mes | 🕐 hora | 📍 lugar` (filled icons always)
